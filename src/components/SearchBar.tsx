    ...
    <div className="bg-white rounded-lg shadow-lg p-2">
      <div className="flex flex-col md:flex-row gap-2">
        ...
        <div className="flex-1 relative">
          <div className="flex items-center gap-2 border border-gray-300 rounded-md px-4 py-3 hover:border-[#B5A189] focus-within:border-[#B5A189] focus-within:ring-2 focus-within:ring-[#B5A189]/20 transition">
        ...
        <button
          ...
          className="bg-[#B5A189] hover:bg-[#9B8B73] text-gray-900 px-8 py-3 rounded-md font-semibold text-sm flex items-center justify-center gap-2 transition shrink-0"
        >
          <Search size={20} />
          Suchen
        </button>
