...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <Link href={`/hotel/${property.id}`} className="block group">
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover-lift transition-all duration-300 hover:border-[#FDC700]/30">
          ...
          <div className="flex-1 p-4 flex flex-col">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <h3 className="text-base font-bold text-gray-900 group-hover:underline decoration-[#FDC700] underline-offset-2 mb-1">
                  {property.name}
                </h3>
              ...
              <div className="text-right shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <div className="bg-[#FDC700] text-gray-900 rounded-tl-lg rounded-tr-lg rounded-br-lg w-10 h-10 flex items-center justify-center text-sm font-bold">
                    {property.rating}
                  </div>
                </div>
              </div>
