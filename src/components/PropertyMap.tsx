  ...
  useEffect(() => {
    ...
    const createIcon = (price: number, isSelected: boolean) => {
      return L.divIcon({
        ...
        html: `<div style="
          background: ${isSelected ? "#111827" : "#FDC700"};
          ...
          border: 2px solid ${isSelected ? "#FDC700" : "white"};
      ...
      marker.bindPopup(`
        <div style="min-width: 200px; font-family: system-ui, sans-serif;">
          ...
          <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <span style="background: #FDC700; color: #111827; padding: 2px 8px; border-radius: 4px; font-weight: 700; font-size: 12px;">${p.rating}</span>
          </div>
          <a href="/hotel/${p.id}" style="display: block; text-align: center; margin-top: 8px; background: #FDC700; color: #111827; padding: 6px; border-radius: 6px; font-size: 12px; font-weight: 600; text-decoration: none;">Details ansehen</a>
        </div>
      `);
