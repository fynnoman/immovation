      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="lg:hidden flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-md text-sm hover:border-[#FDC700] transition"
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-md text-sm bg-white outline-none hover:border-[#FDC700] focus:border-[#FDC700] transition"
            >
            ...
            {viewMode === "map" ? (
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-[#FDC700] text-gray-900 rounded-md text-sm font-medium hover:bg-[#d4b500] transition"
                >
                  Filter zurücksetzen
                </button>
              </div>
    ...
    <Suspense
      fallback={
        <div className="bg-gray-50 min-h-screen">
          <div className="bg-[#FDC700] py-4">
            <div className="max-w-7xl mx-auto px-4">
              <div className="h-14 bg-[#d4b500]/30 rounded-lg animate-pulse" />
            </div>
          </div>
          <div className="max-w-7xl mx-auto px-4 py-6">
